	...
	<div>
		<table class="table table-hover table-striped">
			...
			<tr>
				...
				<button class="btn btn-mini btn-danger" type="button" onclick="diaryTypeDelete(${diaryTypeList.diaryTypeId})">删除</button>
				</td>
			</tr>
			</c:forEach>
		</table>
	</div>
	<div><font color="red" id="error" >${error}</font></div>
</div>