...
<div class="data_list">
	...
	<c:choose>
		<c:when test="${diaryType.diaryTypeId}!=null">
			<img src="${pageContext.request.contextPath}/images/diary_edit_icon.png"/>
	修改日志类别
		</c:when>
		<c:otherwise>
	...
	<form action="diaryType?action=save" method="post" onsubmit="checkForm()">
		<div class="diaryType_form">
		<input type="hidden" id="diaryTypeId" name="diaryTypeId" value="${diaryType.diaryTypeId}"  style="margin-top:5px;height:30px;"/>
